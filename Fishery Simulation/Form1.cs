    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (fileExistsCheck() == true && userClick == true)
            {
                ...
                //System.Threading.Thread.Sleep(16);  // SS to get next random because every Environment.Tickcount is 15.6ms
                oThread.Start(this);
            ...
            try
            {
                if (textBox3.Text.ToString().Trim().Length > 0)
                {
                   ...
                   // pInfo.WindowStyle = ProcessWindowStyle.Normal;
                    ...
                    System.Threading.Thread.Sleep(18);  // SS to get next random because every Environment.Tickcount is 15.6ms
                    Thread.SpinWait(16);
